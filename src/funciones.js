...
export function confirmar(urlConslah,id,titulo,mensaje){
    var url = urlConslah+id;
    const swalWithBootstrapButton = Swal.mixin({
        customClass: {confirmButton:'btn btn-success me-3', cancelButton:'btn btn-danger'},
            ...
            swalWithBootstrapButton.fire({
                ...
                confirmButtonText:'<i class="fa-solid fa-check"></i> Si, deseo eliminar este estudiante', 
...
export function enviarSolicitud(metodo,parametros,url,mensaje){
    axios({ method:metodo,url:url,data:parametros }).then(function(res){
        ...
        if(estado == 200){
            ...
            mostrarAlerta('Servidor no disponible')
    });
}